  ...
  - dialog "Barcode Scanner" [ref=e90]:
    ...
    - generic [ref=e112]:
      - generic [ref=e113]:
        ...
        - button "Batch (0)" [active] [ref=e116] [cursor=pointer]
      - generic [ref=e117]:
        - generic [ref=e118]:
          - textbox "Scan or enter ISBN..." [ref=e119]
          - button "Add" [ref=e120] [cursor=pointer]
        - generic [ref=e121]: Books will be looked up automatically. Use retry button if lookup fails.
```