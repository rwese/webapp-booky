...
const PerformancePage = lazy(() => import('./pages/Performance').then(module => ({ default: module.PerformancePage as ComponentType<unknown> })) as Promise<{ default: ComponentType<unknown> }>);
