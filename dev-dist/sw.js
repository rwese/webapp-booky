...
define(['./workbox-36e57b92'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/books\.google\.com\/.*$/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/www\.googleapis\.com\/books\/.*$/i, new workbox.NetworkFirst({
